...
#p
	...
	:find_max_j_p1
		s:.*; ::
		s:.*:<MAX>&#return_max_result_p1<XAM>:
		b max_pos
		:return_max_result_p1
			s:<MAX>(..)##return_max_result_p1<XAM>:\1:
p
	1h;1!H
	$ b sum_values
b EOS
...
:sum_values
	x
	s:\n: :g
	s:.*:<CADD>&#return_cadd_result_sv<DDAC>:
p
	b custom_add
	:return_cadd_result_sv
		s:<CADD>([0-9]+)##return_cadd_result_sv<DDAC>:\1:
	b print_result
b EOS

:user_redirects
	/##return_max_result_p1/ b return_max_result_p1
	/##return_cadd_result_sv/ b return_cadd_result_sv
b EOS
