...
:debug
	...
	1v
	b main
	#s:.*:<INC>&#result_debug<CNI>:;b incr_pos
	#s:.*:<DEC>&#result_debug<CED>:;b decr_pos
	#s:.*:<ADD>&#result_debug<DDA>:;b add_pos
	#s:.*:<MAX>&#result_debug<XAM>:;b max_pos
	#s:.*:<SEQ>&#result_debug<QES>:;b seq_pos
	#s:.*:<SUBSET>&#result_debug<TESBUS>:;b subset_pos
	#s:.*:<INTERSECTION>&#result_debug<NOITCESRETNI>:;b intersection_pos
	:result_debug
		s:<[^>]+>([^#]+)#[^<]+<[^>]+>:\1:p
b EOS
