...
#P1 O -> P1 P2<
:gen_move_part2
	s:(A) X:\1 Z<:;/</b calc_score
        s:(A) Y:\1 X<:;/</b calc_score
        s:(A) Z:\1 Y<:;/</b calc_score
        s:(B) X:\1 X<:;/</b calc_score
        s:(B) Y:\1 Y<:;/</b calc_score
        s:(B) Z:\1 Z<:;/</b calc_score
        s:(C) X:\1 Y<:;/</b calc_score
        s:(C) Y:\1 Z<:;/</b calc_score
        s:(C) Z:\1 X<:;b calc_score
b EOS
...
:user_redirects
	/##result_ap_ts<DDA>/b result_ap_ts
b EOS
